...
from Models.parser import GrammarRelationParser, LogicalFormParser, MaltParser, ProcedureFormParser, clean_output_files
grammar = """
    start: WORD+
...
with open("Input/query.txt", "r") as f:
    ...
    for line in f:
        ...
        try:
            ...
            grammar_relation = GrammarRelationParser(arcs, index)
            rel = grammar_relation.parse()
            logical_form_parser = LogicalFormParser(rel, index)
